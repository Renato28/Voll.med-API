...
class MedicoRepositoryTest {
    ...
    private Medico cadastrarMedico(String nome, String email, String crm, Especialidade especialidade) {
        var medico = new Medico(dadosMedicos(nome, email, crm, especialidade));
        em.persist(medico);
        return medico;
    }

    private DadosCadastroMedico dadosMedicos(String nome, String email, String crm, Especialidade especialidade) {
